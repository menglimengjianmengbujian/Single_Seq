...
def train(epoch):
    ...
    for i, x in enumerate(CESM_10_train_l):
        ...
        print('Training Epoch: {epoch} [{trained_samples}/{total_samples}]\tLoss: {:0.4f}\tLR: {:0.6f}'.format(
            ...
            epoch=epoch,
            trained_samples=i * args.b + len(data),
...
if __name__ == '__main__':
    ...
    train_root = r"C:\Users\Administrator\Desktop\临时\train"
    val_root = r"C:\Users\Administrator\Desktop\临时\valid"
    ...
    parser.add_argument('-b', type=int, default=64, help='batcdh size for dataloader')
    ...
    net = model(3, num_classes=2, freeze_weights=False)
