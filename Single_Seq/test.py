...
# from models.ConvNetT import CustomConvNeXtTiny as model
from models.vgg import *
from conf import settings
from utils import get_network, WarmUpLR, \
    most_recent_folder, most_recent_weights, last_epoch, best_acc_weights,ConfusionMatrix
from dataset import CESM

# 指定保存数据的路径和文件名
file_path = r'C:\Users\Administrator\Desktop\LJJ\testdata.csv'
...
if __name__ == '__main__':
    ...
    CESMdata2 = CESM(base_dir=r"C:\Users\Administrator\Desktop\LJJ\test",
    ...
    net = model(in_channels=3, num_classes=2, freeze_weights=False)


    net.to(device)

    path1 = r'E:\pycharmproject\LJJ\checkpoint\Resnet50\Wednesday_05_June_2024_19h_28m_32s\Resnet50-56-best.pth'
    ...
    name = ['benign', 'malignent'] # 混淆矩阵的坐标轴名，0为benign，1为malignent，与预处理时候保存的0,1对应
    confusion = ConfusionMatrix(num_classes=2, labels=name)
    confusion.update(pro_lab, label)
